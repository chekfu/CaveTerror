...
class StartTile(MapTile):
    def intro_text(self):
        ...
        You can make four paths, each equally as dark and foreboding.
        '''
...
class EnemyTile(MapTile):
    def __init__(self, x, y):
        ...
        if r < 0.50:
            ...
            self.dead_text = 'The corpse of dead spider rots on the ground'
        elif r < 0.80:
            ...
            self.alive_text = 'You disturbed a rock monster from his slumber'
...
class TraderTile(MapTile):
    ...
    def intro_text(self):
        return '''
        A frail not-quite-human, not-quite-creature squats 
        in the corner clinking his gold together. 
